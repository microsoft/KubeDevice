...
def copySchedToMain():
    ...
    oscmd("find . -name '*.go' -exec sed -i 's?k8s.io/kubernetes/pkg/scheduler?github.com/Microsoft/KubeDevice/kube-scheduler/pkg?g' {} +")
    oscmd("find . -name '*.go' -exec sed -i 's?k8s.io/kubernetes/cmd/kube-scheduler?github.com/Microsoft/KubeDevice/kube-scheduler/cmd?g' {} +")
